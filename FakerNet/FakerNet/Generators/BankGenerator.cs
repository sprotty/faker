...
namespace FakerNet
{
    partial class BankGenerator
    {
        ...
        public string Iban(string countryCode = "GB")
        {
            ...
            if (Faker.TryFetchYamlValue($"bank.iban_details.{countryCode.ToLower()}.bban_pattern", out var pattern, out _) == false)
            ...
            return countryCode.ToUpper() + iban_checksum(countryCode, account) + account;
        }
        ...
        private string iban_checksum(string country_code, string account)
        {
        ...
        private string compile_bsb_number()
        {
            ...
            return digit01 + state + Faker.String.RandomDigits(3);
        }
        ...
        private string compile_routing_number()
        {
            ...
            return digit01 + Faker.String.RandomDigits(7);
        }
